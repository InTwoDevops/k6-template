...
export const healthTresholds = {
  ...
  // 'http_req_duration{path:get_sync_aync}': CONFIG.REQUEST_DURATION_TRESHOLD,
  // 'http_req_failed{path:get_sync_async}': CONFIG.REQUEST_FAILED_TRESHOLD,
  //
...
export function getSyncAsync(token) {
  // console.log(token)
  const res = http.get(`${CONFIG.BASE_URL}/sync-async`);
